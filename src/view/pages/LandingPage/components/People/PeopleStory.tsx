...
interface PeopleStoryProps {
  title: string
  team: Array<People>
}
export default function PeopleStory({ title, team }: PeopleStoryProps) {
        ...
        <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
          <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
            <div className="absolute -top-20 -mt-8 left-1/2 transform -translate-x-1/2">
              ...
              <Image className="relative flex-shrink-0 object-cover rounded-full" src={item.photo} alt="" />
            </div>
            <blockquote className="text-xl font-medium mb-4">{t(item.description)}</blockquote>
